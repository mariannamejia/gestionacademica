...
const Capacitaciones = () => {
  ...
  const filteredData = transformedData.filter((row) => row.tpgestion === "Capacitación");
  ...
  const fetchData = async () => {
    try {
      ...
      setDatos((prevDatos) => ({
        ...
        instructor: gestiones.map((data) => data.instructor),
...
useEffect(() => {
  if (alert) {
    const timer = setTimeout(() => {
      closeAlert();
    }, 7000); // 5000 millisegundos = 5 segundos
    ...
    <div className="Capacitacion__Page">
      ...
      <Sidebar />
        <div className="Administracion__div">
          <h1 className="Administracion__h1">Administración de Capacitaciónes</h1>
            <div className="Admin">
